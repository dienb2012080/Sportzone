                ...
                <div className='mt-5 '>
                    <div className='flex gap-4 justify-between h-[400px]'>
                        <div className='flex-1 h-full shadow-lg rounded-md flex flex-col p-4'>
                            <h4 className='font-bold'>Số bài đăng cho thuê sân bóng rỗ</h4>
                            <ChartLine
                                data={data?.ctpt}
                                isMonth={isMonth}
                        ...
                        <div className='flex-1 h-full shadow-lg rounded-md flex flex-col p-4'>
                            <h4 className='font-bold'>Số bài đăng cho thuê sân bóng chuyền</h4>
                            <ChartLine
                                data={data?.ctmb}
                                isMonth={isMonth}
                                customTime={customTime}
                    ...
                    <div className='flex gap-4 justify-between h-[400px]'>
                        <div className='flex-1 h-full shadow-lg rounded-md flex flex-col p-4'>
                            <h4 className='font-bold'>Số bài đăng cho thuê sân bóng đá</h4>
                            <ChartLine
                                data={data?.ctch}
                                isMonth={isMonth}
                                customTime={customTime}
                        ...
                        <div className='flex-1 h-full shadow-lg rounded-md flex flex-col p-4'>
                            <h4 className='font-bold'>Số bài đăng nhà cho thuê sân cầu lông</h4>
                            <ChartLine
                                data={data?.nct}
                                isMonth={isMonth}
                                customTime={customTime}
